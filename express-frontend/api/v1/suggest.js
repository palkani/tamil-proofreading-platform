...
// Backend is single-region (asia-south1); the URL is read from BACKEND_URL
// so it's managed in Vercel env rather than hardcoded here.
...
const BACKEND_URL = (typeof process !== 'undefined' && process.env && process.env.BACKEND_URL)
  || 'https://prooftamil-backend-991187041222.asia-south1.run.app';
