...
const { CHUNK_MIN_CHARS, CHUNK_OVERLAP_RATIO, CHUNK_TARGET_TOKENS } = require('./config');
...
function splitOversizedBlock(block, targetTokens) {
...
function chunkText(content, targetTokens = CHUNK_TARGET_TOKENS) {
...
module.exports = { extractContent, chunkText, estimateTokens };
