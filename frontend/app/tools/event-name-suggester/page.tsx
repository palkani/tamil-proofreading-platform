...
export default function EventNameSuggesterPage() {
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] text-[#0F172A]">
      ...
      <div className="max-w-3xl mx-auto px-6 py-12">
        <h1 className="text-4xl font-bold text-[#0F172A] mb-4">Event Name Suggester</h1>
        <p className="text-[#475569] mb-6">Generate catchy, realistic event names in Tamil, English, or bilingual style.</p>
