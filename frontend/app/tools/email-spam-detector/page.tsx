...
export default function EmailSpamDetectorPage() {
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] text-[#0F172A]">
      ...
      <div className="max-w-3xl mx-auto px-6 py-12">
        <h1 className="text-4xl font-bold text-[#0F172A] mb-4">Email Spam Detector</h1>
        <p className="text-[#475569] mb-6">Check if an email (subject and body) looks like spam. Free quick check for Tamil and English emails.</p>
